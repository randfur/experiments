...
export class Game {
  ...
  constructor({canvas, viewWidth, viewHeight, viewScale, run}) {
    this.canvas = canvas;
    this.width = viewWidth / viewScale;
    this.height = viewHeight / viewScale;
    ...
    this.drawing = new Drawing({game: this, clearFrames: true, viewScale});
