import {clearDebugPrint, currentTime, debugPrint, randomColour, deviate, onClick, smooth, sleep, timeProgress, nextFrame} from './utils.js';
...
async function run() {
  ...
  while (true) {
    const forceFactor = smooth(timeProgress(start, rampUpDuration)) * forceMaxFactor;
